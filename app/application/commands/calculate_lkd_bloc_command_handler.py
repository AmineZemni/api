...
class CalculateLKDBlocCommandHandler(Command):
    def execute(self) -> str:
        ...
        aoc_step_path = "test_inputs/aoc_step.csv"
        calc_process_path = "test_inputs/calc_process.csv"
        cf_items_path = "test_inputs/cf_items.csv"
        discount_types_path = "test_inputs/discount_types.csv"
        reporting_process_path = "test_inputs/reporting_process.csv"
        run_types_path = "test_inputs/run_types.csv"
        timeframe_path = "test_inputs/timeframe.csv"
        uao_path = "test_inputs/uao.csv"
        lrc_input_proj_path = "test_inputs/lrc_input_proj.csv"
        monthly_yield_curves_path = "test_inputs/monthly_yield_curves.csv"
